...
<div class="row">
    <div class="col-xs-12 col-lg-4">
        <ul>
<?php foreach($top['_child'] as $child): ?>
            <li><a href="<?php echo yii\helpers\Url::to(['product/index', 'cateid' => $child['id']]) ?>"><?php echo $child['title'] ?></a></li>
<?php endforeach; ?>
        </ul>
    </div>
