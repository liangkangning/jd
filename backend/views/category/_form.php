...
<?=$form->field($model, 'tempindex')->textInput(['class'=>'form-control c-md-2'])->label('封面模板')?>
<?=$form->field($model, 'templist')->textInput(['class'=>'form-control c-md-2'])->label('列表模板')?>
<?=$form->field($model, 'tempitem')->textInput(['class'=>'form-control c-md-2'])->label('内容模板')?>
