...
$url = "http://kang.juda.cn/article/index";
/* 加载页面级别资源 */
    ...
    [
        ...
        'buttons' => [
            'edit' => function ($url, $model, $key) {
                return Html::a('<i class="fa fa-edit"></i>', 'http://kang.juda.cn/article/edit?id='.$model->id, [
                    'title' => Yii::t('app', '编辑'),
...
jQuery(document).ready(function() {
    highlight_subnav('/prohibited-words/article'); //子导航高亮
});
<?php $this->endBlock() ?>
<!-- 将数据块 注入到视图中的某个位置 -->
