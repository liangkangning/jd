...
class NewsController extends CommonController
{
    ...
    public function init()
    {
        ...
        if (YII_ENV=="dev"){
            Yii::$app->params['isAllowedIp'] = true;
        }
    ...
    public function actionDetail(){
        ...
        if(Yii::$app->request->isGet){
            ...
            if ($id==152080){
                //dump((new \common\helpers\Visitors())->GetIps());
            }
...
//            $item->save();
            ...
            if (Yii::$app->params['isAllowedIp']&&strlen($item['name'])>0){//如果是特殊文章，然后可以显示的话，页面就显示完整
                Yii::$app->params['zhuti-display'] = true;
            }else{
