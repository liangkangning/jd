...
<div class="column-lifepo4 column-common">
    <div class="col-md-12">
        <div class="">
            <section>
                <div class="common_title size1 section10" id="basic-structure-of-18650"><h2 class="light1-5">磷酸铁锂电池概述</h2></div>
            ...
            <section>
                ...
                <div class="section20 col-md-12 common_p">
                    <table cellspacing="0" width="100%" class="table-bordered">
                        <tbody>
                        <tr class="firstRow">
                            <td>正极材料</td>
            ...
            <div class="part4 pp">
                <div class="container">
                    ...
                    <div class="common_p section10">
                        ...
                        <li class="col-md-12 section20"><strong>放电深度</strong></li>
                        <p class="section10 col-md-12">
                            放电的深度是影响磷酸铁锂电池寿命的主要因素，放电的深度越高，磷酸铁锂电池的寿命就越短。换句话说，只要降低放电深度，就能大幅延长锂磷酸铁锂电池的使用寿命。因此，我们应避免将锂电池UPS过放至极低的电压。
                        </p>
                        <li class="col-md-12 section20"><strong>工作环境</strong></li>
                        <p class="section10 col-md-12">
        ...
        <section>
            <div class="container">
                ...
                <div class="common_p">
                    <li class="col-md-12 section20"><strong>火法回收工艺</strong></li>
                </div>
                <div class="common_p">
                    <p class="section10 col-md-12">
                ...
                <div class="common_p">
                    <li class="col-md-12 section20"><strong>湿法回收工艺</strong></li>
                </div>
                <div class="common_p">
